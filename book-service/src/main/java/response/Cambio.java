...
public class Cambio implements Serializable {
	...
	/*
	 * este será um objeto trafegado entre os 2 micro-serviços, Book-server e
	 * cambio-Server
	 */
	...
	public Double getConvetionFactor() {
		return conversionFactor;
	}

	public void setConvetionFactor(Double conversionFactor) {
		this.conversionFactor = conversionFactor;
	}
